...
namespace Citizen_App_Server
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            .AddCookie()
            .AddOpenIdConnect(Configuration["oidc:AuthenticationScheme"], options => {
                ...
                options.ClaimsIssuer = Configuration["oidc:ClaimsIssuer"];
                ...
                options.Events = new OpenIdConnectEvents
                {
                    ...
                    {
                        var logoutUri = $"https://{Configuration["oidc:Domain"]}/v2/logout?client_id={Configuration["oidc:ClientId"]}";
